...
/**
 * Cloudflare/OpenNext only supports Edge Middleware, while Next.js 16 proxy
 * defaults to Node.js runtime. Keep this file on the middleware convention for
 * the Cloudflare deployment target.
 *
...
export async function middleware(request: NextRequest) {
  ...
  // 通过上面的 setAll 写回 response。注意不要在 middleware 与 getUser 之间加任何
